...
def main():
    ...
    if args.saveFile == None:
        saveFile = os.path.join(os.getcwd(),f'reveal_{"features" if args.jurisdiction == "true" else "structures"}_{args.server}.geojson') if args.type == 'geojson' else os.path.join(os.getcwd(),f'reveal_{"features" if args.jurisdiction == "true" else "structures"}_{args.server}.xlsx')
